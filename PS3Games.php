...
if(isset($_POST['add_to_cart']))
{
    ...
    header("location:PS3Games?success=1");
}
?>
...
<div class="main">
    <?php
      include_once './dbConfig.php';
      $query = "SELECT * FROM products WHERE category='ps3game' ";
    ...
    <form method="POST">
        <div class="card">
            <img src="./Uploads/Ps 3 games/<?php echo $row["image"]; ?>" width="150px" height="130px">
