...
<head>
  ...
  <body oncontextmenu="return false" class="snippet-body" background="./Images/Back.jpg">
        ...
        <div class="media mt-3 pl-2">
            ...
            <form class="row g-3" action="./stk_initiate.php" method="POST">
                ...
                <div class="col-12">
                  ...
                  <input type="text" class="form-control" name="amount" placeholder="Enter Amount" value="Kshs <?php echo  $total;?>" readonly>
                </div>
                <div class="col-12">
                  <label for="inputAddress2" class="form-label" >Phone Number</label>
                  <input type="text" class="form-control" name="phone" placeholder="254712345678" required>
                </div>
